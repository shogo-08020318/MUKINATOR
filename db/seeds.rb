...
Reason.create(
  [
    ...
    { name: '筋トレすると睡眠の質が65%⤴︎、日中の眠気65%⤵︎、筋トレは立派な睡眠剤！', trouble_id: 10 },
    ...
    { name: '筋トレすると日々の充実感が得られる、自分を律することができる、自己肯定感が高くなるからやるしかない！',
      trouble_id: 15 },
...
WiseSaying.create(
  [
    ...
    { name: 'ショートカットなどこの世には存在しない。', people: 'アーノルド・シュワルツェネッガー' },
    { name: '利益だけを考える女々しい男になるな。', people: 'アーノルド・シュワルツェネッガー' },
    { name: '君の健康に最もいい行動は、パンプと女性を楽しむこと', people: 'アーノルド・シュワルツェネッガ' },
    { name: '困難を乗り越えた時が最高。だから、困難を乗り越える', people: 'アーノルド・シュワルツェネッガ' },
    { name: 'ポジティブは伝染する。勝者に関わっていることは君を勝者へと導く', people: 'アーノルド・シュワルツェネッガ' },
    { name: '限界を決めるのはあなたの心だ。あなたができると思う限りそれは可能なのだ。', people: 'アーノルド・シュワルツェネッガ' },
    { name: 'ハングリー精神を忘れてしまったら、その人は生きているのではなく、単に存在しているに過ぎない',
      people: 'アーノルド・シュワルツェネッガ' },
    { name: '真のトレーニングとはやめたいと思った時から始まる', people: 'ロニー・コールマン' },
    { name: '筋肉という名の衣服を日々の努力で縫い上げていく', people: 'ロニー・コールマン' },
    { name: '肉体的にも精神的にも真のチャンピオンになりたい', people: '安井友梨' },
    { name: '肉体的にも精神的にも真のチャンピオンになりたい', people: '安井友梨' },
    { name: '自らの心が勝敗に支配される限り、決して心の安寧など存在しない', people: 'マッスル北村' },
    { name: '壁にぶち当たったときこそ真のスタートライン', people: 'マッスル北村' },
    { name: '自分で自分に心から「よくやった」と、一言言える闘いこそ、誠の勝利', people: 'マッスル北村' },
    { name: 'ボディビルはアート', people: 'カイグリーン' },
    { name: '昨日より良い結果を出すという目標と共に目覚めよ', people: 'ジェレミー・ブエンディア' },
    { name: '完璧な体のためには行動しなきゃダメだ。ソファーに座ってるだけではそれは叶わない。',
      people: 'ジェレミー・ブエンディア' },
    { name: '自分よりすごい肉体の人がいることが気に食わなかった', people: '横川尚隆' },
    { name: 'モチベーションがないなら、やらない方が良い', people: '田代誠' },
    { name: '運命の赤い糸は筋繊維の事', people: 'ナイアジム' }
  ]
)
