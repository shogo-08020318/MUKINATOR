...
Trouble.create(
  [
    ...
    { name: '物忘れ、記憶を無くす', kind: 0 },
    { name: '間食をよく食べる', kind: 0 },
    { name: '痩せない', kind: 0 },
    { name: '肌トラブル', kind: 0 },
    { name: '冷え性', kind: 0 },
    { name: '眠れない、起きれない', kind: 0 },
    { name: '好きなものが高カロリー', kind: 0 },
    { name: 'ビール腹問題', kind: 0 },
...
Reason.create(
  [
    ...
    { name: '成長ホルモンの分泌量が増え、血流と睡眠の質が向上し、ストレス解消になって肌環境が良くなる、やらない理由はない！',
      trouble_id: 8 },
    ...
    { name: '筋トレすると、日々の充実感が得られる、自分を律することができる、自己肯定感が強くなる、筋トレ最高！',
      trouble_id: 15 },
    ...
    { name: ' 筋トレをすると日々変わる体重体型などを数値で見て成長を実感でき、自分で自分を評価するようになる！',
      trouble_id: 22 },
    { name: '人はほぼ水分とタンパク質でできている。プロテインと話していると思え！', trouble_id: 23 },
    { name: '筋トレをすると身体が変わって、自己肯定感や継続力など色んなものが身について自信が持てるようになる！',
      trouble_id: 24 },
    { name: '「ごめん、今からジム行ってくる！」で逃げる！', trouble_id: 25 },
    { name: '人はほぼ水分とタンパク質でできている。喋るプロテインだ！', trouble_id: 26 },
    { name: '筋トレは世界共通言語！「Do you want to hit the gym together with me?」でOK！',
      trouble_id: 27 },
